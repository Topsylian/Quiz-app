...
registerBtn.addEventListener("click", function (e) {
  ...
  console.log(name, uname, pword);
  const savedName = localStorage.setItem("name", name);
  const savedUser = localStorage.setItem("uname", uname);
  const savedPass = localStorage.setItem("pword", pword);
});
